...
public class RatioPathCompanyDeleteJob {
    ...
    private final static class RatioPathCompanyDeleteSink extends RichSinkFunction<SingleCanalBinlog> {
        ...
        public void invoke(SingleCanalBinlog singleCanalBinlog, Context context) {
            ...
            String res = jdbcTemplate.queryForObject("select 1 from investment_relation where company_id_invested = " + companyIdString, rs -> rs.getString(1));
            if (res == null) {
                dao.deleteAll(Long.parseLong(companyIdString));
            }
        }
    }
}
