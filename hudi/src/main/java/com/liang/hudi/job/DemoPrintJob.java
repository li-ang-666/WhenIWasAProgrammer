...
public class DemoPrintJob {
    public static void main(String[] args) throws Exception {
        // read file
        InputStream stream1 = DemoPrintJob.class.getClassLoader().getResourceAsStream("DemoJob/source.sql");
        String source = IOUtils.toString(stream1, StandardCharsets.UTF_8);
        InputStream stream2 = DemoPrintJob.class.getClassLoader().getResourceAsStream("DemoJob/sink.sql");
