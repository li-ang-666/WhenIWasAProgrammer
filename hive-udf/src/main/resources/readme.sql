...
create function doris.to_bitmap as 'com.liang.udf.ToBitmapUDAF' USING JAR 'hdfs:///liang/hive-udf-1.0.jar';
drop function if exists doris.bitmap_union;
create function doris.bitmap_union as 'com.liang.udf.BitmapUnionUDAF' USING JAR 'hdfs:///liang/hive-udf-1.0.jar';

-- 创建UDF函数
drop function if exists doris.bitmap_count;
create function doris.bitmap_count as 'com.liang.udf.BitmapCountUDF' USING JAR 'hdfs:///liang/hive-udf-1.0.jar';
drop function if exists doris.bitmap_and;
create function doris.bitmap_and as 'com.liang.udf.BitmapAndUDF' USING JAR 'hdfs:///liang/hive-udf-1.0.jar';
drop function if exists doris.bitmap_or;
create function doris.bitmap_or as 'com.liang.udf.BitmapOrUDF' USING JAR 'hdfs:///liang/hive-udf-1.0.jar';
drop function if exists doris.bitmap_xor;
create function doris.bitmap_xor as 'com.liang.udf.BitmapXorUDF' USING JAR 'hdfs:///liang/hive-udf-1.0.jar';
