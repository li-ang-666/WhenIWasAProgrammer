...
public class BitmapUnion extends Aggregator<byte[], Roaring64Bitmap, byte[]> {
    @Override
    ...
    @Override
    public Roaring64Bitmap reduce(Roaring64Bitmap b, byte[] a) {
        b.or(BitmapUtils.deserialize(a));
        return b;
    }
