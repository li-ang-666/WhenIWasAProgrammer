...
public class PxCheckJob {
    public static void main(String[] args) throws InstantiationException, IllegalAccessException {
        ...
        spark.sql("insert overwrite table ads.ads_bdp_equity_entity_controller_details partition(pt = '20230908') select /*+ REPARTITION(360) */ * from t");
        spark.sql("insert overwrite table ads.ads_bdp_equity_entity_beneficiary_details partition(pt = '20230908') select /*+ REPARTITION(360) */ * from tt");
        spark.sql("insert overwrite table ads.ads_bdp_equity_shareholder_identity_type_details partition(pt = '20230908') select /*+ REPARTITION(360) */ * from ttt");
        //年报
        ...
        spark.sql("insert overwrite table ads.ads_entity_operation_development_entity_annual_report_shareholder_equity_change_details partition(pt = '20230908') select /*+ REPARTITION(360) */ * from t3");
        spark.sql("insert overwrite table ads.ads_entity_operation_development_entity_annual_report_shareholder_equity_details partition(pt = '20230908') select /*+ REPARTITION(360) */ * from t4");
        spark.sql("insert overwrite table ads.ads_entity_operation_development_entity_annual_report_investment_details partition(pt = '20230908') select /*+ REPARTITION(360) */ * from t6");
        spark.sql("insert overwrite table ads.ads_entity_operation_development_entity_annual_report_ebusiness_details partition(pt = '20230908') select /*+ REPARTITION(360) */ * from t7");
        // 工商
